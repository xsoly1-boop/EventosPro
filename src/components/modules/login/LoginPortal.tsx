...
import { Shield, User, QrCode, Sparkles, KeyRound } from "lucide-react";
          ...
          <form onSubmit={handleHostSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-obsidian border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-all duration-300 text-center tracking-widest uppercase font-semibold"
              />
