                      ...
                      if (window.confirm(`¿Confirmar Pre-reserva para el día ${selectedDateStr}?`)) {
                        try {
                          ...
                          const newEvent = {
                            ...
                            guestLimit: preReserveDraft.guestsCount,
                            clientName: preReserveDraft.clientName,
                            phone: preReserveDraft.phone,
                            clientInfo: {
                              name: preReserveDraft.clientName,
                              phone: preReserveDraft.phone || "",
                              email: "",
                              rfc: "",
                              address: ""
                            },
                            packageName: preReserveDraft.packageName || "Paquete Básico Imperial",
                            packagePrice: Number(preReserveDraft.packagePrice) || 350,
                            fixedServices: preReserveDraft.fixedServices || [],
                            status: "pre-reserva",
                            paidAmount: 0,
                            enableBalcony: false,
                            honorCapacity: 5,
